...
public class Flight implements IFlight {
    ...
    public double getCarbonOffset() {
        ...
        return aircraft.getEmission()*miles;
    }
    ...
    public int getNumberOfBookedSeats() {
        ...
        return (int) bookings.stream().filter( item -> !item.isCancelled()).count();
    }
    ...
    public boolean hasAvailableSeats() {
        // TODO - Write your code here
        return getMaxSeats() > getNumberOfBookedSeats();
    }
    ...
    public boolean hasSameRoute(IFlight other) {
        return other.getOrigin().equals(origin) && other.getDestination().equals(destination);
    }
    ...
    public void updateAircraft(IAircraft aircraft, boolean forceChange) {
        // TODO - Write your code here
        if (!forceChange && aircraft.getSeats() < getNumberOfBookedSeats()) {
    ...
    public String toString(){
        return aircraft.getType() + " " + origin + " going to " + destination;
    }
